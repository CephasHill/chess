...
public class ServiceTests {
    ...
    public void registerPos() throws DataAccessException {
        RegisterResult res = userService.register(new RegisterRequest("name", "pass", "email"));
    ...
    public void registerNeg() {
        ...
        assertThrows(DataAccessException.class, () -> {
            userService.register(new RegisterRequest("name","l",null)); // Duplicate username
        });
    }
    @Test
    ...
    public void logoutPos() throws DataAccessException {
        RegisterResult regRes = userService.register(new RegisterRequest("name", "pass", "email"));
        LogoutResult res = userService.logout(new LogoutRequest(regRes.authData().authToken()));
        assertNotNull(res);
    ...
    public void logoutNeg() {
        ...
        assertThrows(DataAccessException.class, () -> {
            userService.logout(new LogoutRequest("j"));
        });
    }
    @Test
    ...
    public void loginPos() throws DataAccessException {
        ...
        LogoutResult logoutRes = userService.logout(new LogoutRequest(regRes.authData().authToken()));
        LoginResult loginRes = userService.login(new LoginRequest("user","pass"));
    ...
    public void loginNeg() {
        ...
        assertThrows(DataAccessException.class, () -> {
            userService.login(new LoginRequest("name","pass"));
        });
    }
    @Test
